    ...
    <div className='flex min-h-screen flex-col'>
      ...
      <div className='flex grow flex-col items-center justify-center'>
        ...
        <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
            <b style={{marginBottom: 10, fontSize:40}}>Log Duration</b>
            <div>
                <p style={{textAlign: 'center', fontSize: 35}}>1. Limping</p>
                ...
                <p style={{textAlign: 'center', fontSize: 35}}>2. Coughing</p>
                <div style={{display: 'flex', marginBottom: 10}}>
                    <p style = {{padding: 3, fontSize: 25}}>From:</p>
                    <input type='date' style={{border: '1px solid black', borderRadius: '4px' ,width: 110, fontSize:15}}></input>
                    <p style = {{paddingLeft: 10, padding: 3, fontSize: 25}}>To:</p>
                ...
                <p style={{textAlign: 'center', fontSize: 35}}>3. Lack of appetite</p>
                <div style={{display: 'flex', marginBottom: 10}}>
                    <p style = {{padding: 3, fontSize: 25}}>From:</p>
                    <input type='date' style={{border: '1px solid black', borderRadius: '4px' ,width: 110, fontSize:15}}></input>
                    <p style = {{paddingLeft: 10, padding: 3, fontSize: 25}}>To:</p>
